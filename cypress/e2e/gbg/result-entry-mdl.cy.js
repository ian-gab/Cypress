...
describe('results entry by mdl#', () => {
  ...
  it('open mdl# in qc view reqs', () => {
    ...
    cy.iframe('#Target_Frame').contains('tr', 'Lactobacillus (BV & AV Panel) by Real Time PCR').find('td a').should('be.visible').click()
    ...
    //test 756
    cy.iframe('#Target_Frame').contains('tr', 'BVPanelPCR2 (Avag, UreaUreal, Mo.mulieris)').find('td a').should('be.visible').click()
    cy.wait(5000)
    cy.iframe('#Target_Frame').find('#ddlb_SubtypeResult_1').select('Positive').should('have.value', 'P')
    cy.iframe('#Target_Frame').find('#ddlb_SubtypeResult_2').select('Positive').should('have.value', 'P')
    cy.iframe('#Target_Frame').find('#ddlb_SubtypeResult_3').select('Positive').should('have.value', 'P')
    ...
    //test 757
    cy.iframe('#Target_Frame').contains('tr', 'BVPanelPCR3 (MegaType1, MegaType2, Mgen, Mhom)').find('td a').should('be.visible').click()
    cy.wait(5000)
    cy.iframe('#Target_Frame').find('#ddlb_SubtypeResult_1').select('Positive').should('have.value', 'P')
    cy.iframe('#Target_Frame').find('#ddlb_SubtypeResult_2').select('Positive').should('have.value', 'P')
